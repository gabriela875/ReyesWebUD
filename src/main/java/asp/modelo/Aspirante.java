...
public class Aspirante extends Persona implements Serializable {
    ...
    // Fecha en que el aspirante fue registrado en el sistema
    private LocalDate fecha_reg;
    // Programa academico de interes del aspirante
    ...
    public String toString() {
        return "Aspirante [nombres=" + getNombres() + ", apellidos=" + getApellidos()
